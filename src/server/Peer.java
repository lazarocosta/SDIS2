...
<<<<<<< HEAD:src/server/main/Peer.java
import java.util.*;
...
>>>>>>> e1c91f462a3189f4c36c42aa57e664c16e0624e9:src/server/Peer.java
...
public class Peer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // UsersKeys.insertUserKey(c, 2, a.getAsymmetricPrivateKey().getEncoded());
            //System.out.println("Antes" + "\n" + Arrays.toString(a.getAsymmetricPrivateKey().getEncoded()) + "\n");




            byte[] bytes = UsersKeys.loadUserKey(c, 2);

            if (bytes == null) {
                System.out.println("not load userkey");
                return;
            } else

                System.out.println("load userkey");
            ...
            HybridEncryption novo = new HybridEncryption();
            novo.setAsymmetricKeyPrivate(privateKey);
            System.out.println("depois" + "\n" + Arrays.toString(novo.getAsymmetricPrivateKey().getEncoded()) + "\n");
