...
public class Register extends JFrame{
	...
	private JPasswordField password_confirm_btn;
	...
	private void initialize() {
		this.addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				Login.mainWindow.setVisible(true);
			}
		});
		...
		password_confirm_btn = new JPasswordField();
		password_confirm_btn.setColumns(15);
		this.getContentPane().add(password_confirm_btn, "2, 16");
