                ...
                Thread t = new Thread() {
                    public void run() {
                        try {
                            ...
                            int user_id;
                            if ((user_id = Users.isLoginCorrect(Peer.connection, email_input.getText(), password_input.getText())) != -1) {
                                ...
                                System.out.println("Peer_userid" +Peer.user_id);

                                byte[] privateKeyBytes;
                                if ((privateKeyBytes = UsersKeys.loadUserKey(Peer.connection, Peer.user_id)) != null) {
                                   ...
                                   if(! Peer.hybridEncryption.loadKeysFile()){
                                    ...
                                    UsersKeys.insertUserKey(Peer.connection,Peer.user_id,privateKey.getEncoded());
                                }
