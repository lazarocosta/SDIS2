...
public class Encryptor {
    ...
    public static byte[] encryptAES(SecretKeySpec skeySpec, IvParameterSpec iv, byte[] value) {
        try {
            /*
			 * - CBC (Cipher Block Chaining) makes one ciphertext block validity
			 * depend on all the previous ciphertext blocks. - Padding is a
			 * technique used to increase the length of a message prior to
			 * encryption so that its actual length is not disclosed.
			 */
    ...
    public static SecretKeySpec generateSymmetricKey()
